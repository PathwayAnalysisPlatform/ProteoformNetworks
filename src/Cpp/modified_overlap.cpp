...
void writeReportRecords(ofstream& output,
                        ...
                        const um<string, bitset<total_proteoforms>>& pathways_to_proteoforms,
...
void writePathwayReport(ofstream& output,
                        ...
                        const umss& pathways_to_names,
                        const um<string, bitset<NUM_PROTEOFORMS>>& pathways_to_proteoforms,
                        const vs index_to_proteoforms) {
...
void writePhenotypeReport(ofstream& output,
                          ...
                          const umss& pathways_to_names,
                          const um<string, bitset<NUM_PHEGEN_PROTEOFORMS>>& pathways_to_proteoforms,
                          const vs index_to_proteoforms) {
...
void reportPhenotypePairs(std::string_view path_file_gene_search,
   ...
   const auto [genes_to_traits, traits_to_genes] = loadTraitGeneSets(path_file_PheGenI.data(), GENOME_WIDE_SIGNIFICANCE, phegeni_genes, phegeni_traits, reactome_genes.indexes);
   const auto sets_to_names = createTraitNames(traits_to_genes);
   const um<string, bitset<NUM_PHEGEN_PROTEINS>> traits_to_proteins = convertGeneSets(traits_to_genes, phegeni_genes.entities, genes_to_proteins, proteins_to_index, adjacency_list_proteins);
