...
def traffic_graph(tmpdir_factory):
    ...
    graphs_path = tmpdir_factory.mktemp("tmpdir")
    return create_graph("R-HSA-5627083", "proteoforms", True, graphs_path)
...
def signal_graph(tmpdir_factory):
    ...
    graphs_path = tmpdir_factory.mktemp("tmpdir")
    return create_graph("R-HSA-5654706", "proteoforms", True, graphs_path)
...
def test_connects_inputs_with_outputs(glycolysis_graph):
    ...
    assert ("ATP", "P16118;00046:33") in glycolysis_graph.edges

    # Input to output interactions for reaction R-HSA-163750
    assert not ("P16118", "Pi") in glycolysis_graph.edges
    assert ("P16118;00046:33", "Pi") in glycolysis_graph.edges
...
def test_connects_catalysts_with_outputs(glycolysis_graph):
    ...
    assert ("P16118;00046:33", "Fru(6)P") in glycolysis_graph.edges
    assert not ("P16118", "Pi") in glycolysis_graph.edges
    assert ("P16118;00046:33", "Pi") in glycolysis_graph.edges
...
def test_connects_regulators_with_outputs_2(signal_graph):
    ...
    assert ("Q9GZV9;00164:178", "HS") in signal_graph.edges
    ...
    assert ("HS", "O60258-1") in signal_graph.edges
...
def test_connect_components_of_same_complex_2(signal_graph):
    assert ("P01116-1;00115:179,01116:186", "GTP") in signal_graph.edges
    assert ("P01111;00115:181,01116:186", "GTP") in signal_graph.edges
    assert ("P01112;00115:181,00115:184,01116:186", "GTP") in signal_graph.edges
    assert ("P01116-2;01116:186", "GTP") in signal_graph.edges
    ...
    assert ("HS", "P22607-2;00048:579,00048:649,00048:650,00048:726,00048:762,00048:772") in signal_graph.edges
